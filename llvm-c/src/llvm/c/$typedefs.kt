...
public typealias __darwin_off_t = Long
...
public typealias off_t = __darwin_off_t
...
public typealias LLVMSymbolLookupCallback = Pointer<(
  DisInfo: Pointer<Unit>,
  ReferenceValue: uint64_t,
  ReferenceType: Pointer<uint64_t>,
  ReferencePC: uint64_t,
...
public typealias LLVMOrcJITTargetAddress = uint64_t

public typealias LLVMOrcExecutorAddress = uint64_t

public typealias LLVMJITSymbolTargetFlags = uint8_t
