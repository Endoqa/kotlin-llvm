...
public fun llvm_blake3_hasher_init_keyed(self: Pointer<llvm_blake3_hasher>,
    key: NativeArray<uint8_t>): Unit = `llvm_blake3_hasher_init_keyed$mh`.invokeExact(self,key,) as
    Unit
...
public fun LLVMGetEnumAttributeValue(A: LLVMAttributeRef): uint64_t =
...
public fun LLVMArrayType2(ElementType: LLVMTypeRef, ElementCount: uint64_t): LLVMTypeRef =
...
public fun LLVMGetArrayLength2(ArrayTy: LLVMTypeRef): uint64_t =
...
public fun LLVMDITypeGetSizeInBits(DType: LLVMMetadataRef): uint64_t =
    (`LLVMDITypeGetSizeInBits$mh`.invokeExact(DType,) as Long).toULong()

public fun LLVMDITypeGetOffsetInBits(DType: LLVMMetadataRef): uint64_t =
    (`LLVMDITypeGetOffsetInBits$mh`.invokeExact(DType,) as Long).toULong()

public fun LLVMDITypeGetAlignInBits(DType: LLVMMetadataRef): uint32_t =
...
public fun LLVMDIBuilderCreateExpression(
  Builder: LLVMDIBuilderRef,
  Addr: Pointer<uint64_t>,
  Length: ULong,
): LLVMMetadataRef = `LLVMDIBuilderCreateExpression$mh`.invokeExact(Builder,Addr,Length.toLong(),)
    as MemorySegment

public fun LLVMDIBuilderCreateConstantValueExpression(Builder: LLVMDIBuilderRef, Value: uint64_t):
    LLVMMetadataRef =
...
public fun LLVMGetDINodeTag(MD: LLVMMetadataRef): uint16_t = (`LLVMGetDINodeTag$mh`.invokeExact(MD,)
    as Short).toUShort()
...
public fun LLVMSetDisasmOptions(DC: LLVMDisasmContextRef, Options: uint64_t): Int =
...
public fun LLVMGetGlobalValueAddress(EE: LLVMExecutionEngineRef, Name: Pointer<Byte>): uint64_t =
    (`LLVMGetGlobalValueAddress$mh`.invokeExact(EE,Name,) as Long).toULong()

public fun LLVMGetFunctionAddress(EE: LLVMExecutionEngineRef, Name: Pointer<Byte>): uint64_t =
...
public fun LLVMGetSectionSize(SI: LLVMSectionIteratorRef): uint64_t =
...
public fun LLVMGetSectionAddress(SI: LLVMSectionIteratorRef): uint64_t =
...
public fun LLVMGetSymbolAddress(SI: LLVMSymbolIteratorRef): uint64_t =
    (`LLVMGetSymbolAddress$mh`.invokeExact(SI,) as Long).toULong()

public fun LLVMGetSymbolSize(SI: LLVMSymbolIteratorRef): uint64_t =
    (`LLVMGetSymbolSize$mh`.invokeExact(SI,) as Long).toULong()

public fun LLVMGetRelocationOffset(RI: LLVMRelocationIteratorRef): uint64_t =
...
public fun LLVMGetRelocationType(RI: LLVMRelocationIteratorRef): uint64_t =
...
public fun LLVMRemarkStringGetLen(String: LLVMRemarkStringRef): uint32_t =
...
public fun LLVMRemarkDebugLocGetSourceLine(DL: LLVMRemarkDebugLocRef): uint32_t =
    (`LLVMRemarkDebugLocGetSourceLine$mh`.invokeExact(DL,) as Int).toUInt()

public fun LLVMRemarkDebugLocGetSourceColumn(DL: LLVMRemarkDebugLocRef): uint32_t =
...
public fun LLVMRemarkEntryGetHotness(Remark: LLVMRemarkEntryRef): uint64_t =
    (`LLVMRemarkEntryGetHotness$mh`.invokeExact(Remark,) as Long).toULong()

public fun LLVMRemarkEntryGetNumArgs(Remark: LLVMRemarkEntryRef): uint32_t =
...
public fun LLVMRemarkParserCreateYAML(Buf: Pointer<Unit>, Size: uint64_t): LLVMRemarkParserRef =
    `LLVMRemarkParserCreateYAML$mh`.invokeExact(Buf,Size.toLong(),) as MemorySegment

public fun LLVMRemarkParserCreateBitstream(Buf: Pointer<Unit>, Size: uint64_t): LLVMRemarkParserRef
...
public fun LLVMRemarkVersion(): uint32_t = (`LLVMRemarkVersion$mh`.invokeExact() as Int).toUInt()
