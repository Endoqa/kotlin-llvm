...
@JvmInline
value class CXIdxIncludedFileInfo(
    val `$mem`: MemorySegment,
) {
    var hashLoc: CXIdxLoc
        get() = CXIdxLoc(
            hashLocHandle.invokeExact(this.`$mem`, 0L) as
                    MemorySegment
        )
        set(`value`) {
    ...
    companion object {
        ...
        @JvmField
        val hashLocHandle: MethodHandle =
