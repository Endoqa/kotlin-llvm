...
public value class CXSourceRange(
    ...
    public companion object {
        ...
        @JvmField
        public val begin_int_dataHandle: VarHandle =
            layout.varHandle(MemoryLayout.PathElement.groupElement("begin_int_data"))

        @JvmField
        public val end_int_dataHandle: VarHandle =
            layout.varHandle(MemoryLayout.PathElement.groupElement("end_int_data"))

        @JvmStatic
        public fun allocate(alloc: SegmentAllocator): CXSourceRange =
