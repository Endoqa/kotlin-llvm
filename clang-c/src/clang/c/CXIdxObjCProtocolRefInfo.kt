...
@JvmInline
value class CXIdxObjCProtocolRefInfo(
    val `$mem`: MemorySegment,
) {
    var protocol: Pointer<CXIdxEntityInfo>
    ...
    var cursor: CXCursor
        get() = CXCursor(
            cursorHandle.invokeExact(this.`$mem`, 0L) as
                    MemorySegment
        )
        set(`value`) {
    ...
    companion object {
        ...
        @JvmStatic
        fun allocate(alloc: SegmentAllocator): CXIdxObjCProtocolRefInfo =
